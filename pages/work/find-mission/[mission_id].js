              ...
              <Link href={`/work/find-mission/${v.mission_id}`}>
                <CardContent className="popular-card-content">
                  <Typography
                    level="title-lg"
                    id="card-description"
                    className="size-7 popular-card-title"
                  >
                    {v.title}
                  </Typography>
                  <Typography
  ...
  return (
    <div className="item detailed-description">
      <div className="item-title size-6 ">
        <PiChatTeardropTextThin className="me-1" />
        詳細說明
      </div>
      <hr class="item-divider" />
      <ul
        className="item-introduction size-7"
  ...
  const handleSendClick = async () => {
    ...
    if (autoSend) {
      ...
      chatContentArray.push(
        `<p><h5><strong>✅ 我的小幫手簡歷：</strong></h5></p><p><strong>名字：</strong>` +
          helperInfo.name +
          `</p><p><strong>電話：</strong>` +
          helperInfo.phone +
          `</p><p><strong>Email：</strong>` +
          helperInfo.email +
          `</p><p><strong>個人簡述：</strong>` +
          helperInfo.introduction +
          `</p>`
      );
      // chatContentArray.push(
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title size-5" id="exampleModalLabel">
                立即應徵
              </h5>
              <button
                type="button"
            ...
            <div className="modal-body">
              <div className="profile d-flex justify-content-center align-items-center mt-3">
                ...
                <div className="justify-content-center">
                  ...
                  <p className="size-7 mt-1">{age}歲</p>
                  <p className="size-7 mt-1">
                    {loginUser ? loginUser.city + loginUser.area : ""}
                  </p>
                </div>
              </div>
              <div className="recommend mt-4">
                <div className="size-6 mb-2 recommend-title">
                  自我推薦<span className="size-7">（必填）</span>
                </div>
                <textarea
                ...
                <div className="auto-send d-flex my-4 align-items-center">
                  ...
                  />
                  <div className="size-7 ms-2 auto-send-title">
                    自動發送小幫手履歷
            ...
            <main className="d-flex flex-column flex-lg-row row justify-content-between g-lg-5">
              <div className="left col-12 col-lg-3 order-2 order-lg-1">
                <aside className="post-user">
                  <div className="mt-lg-3">
                    ...
                    <div className="ms-3 mb-3 px-4">
                      <p className="size-7 mb-1">
                        <BiSolidTimeFive />
                        <span className="ms-1">聯絡時段</span>
                      </p>
                      <p>
                    ...
                    <div className="ms-3 mb-3 px-4">
                      <p className="size-7 mb-1">
                        <MdEmail />
                        <span className="ms-1">E-mail</span>
                      </p>
                      <p className="poster-email">{v.email}</p>
                    </div>
                    ...
                    <div className="left-block-btns-group d-flex align-items-center">
                      <button
                        className="left-block-btn d-flex align-items-center justify-content-center"
                        onClick={handleButtonClick}
                      >
                        <div className="left-block-icon">
                          <PiWechatLogoThin />
                        </div>
                        <span>線上詢問</span>
                      </button>
                      {userId && ( // 會員有登入時顯示這顆
                        <button
                          className="left-block-btn apply-now-btn  d-flex align-items-center justify-content-center"
                ...
                <aside className="post-user mt-4">
                  <div className="mt-3 p-4">
                    ...
                    <div>
                      <InteractiveCard
                        popularMissions={popularMissions}
                        setPopularMissions={setPopularMissions}
                      />
                    </div>
                  </div>
                </aside>
              ...
              <div className="right col-12 col-lg-9 order-1 order-lg-2">
                <header className="mt-3 py-4 px-sm-5 position-relative">
                  ...
                  <p className="size-7 mt-3 header-font">
                    刊登日期：{formatDate(v.post_date)}
                  </p>
                  <div className="d-flex mt-2 justify-content-between flex-column flex-sm-row">
                    <p className="size-7 header-font">
                      最後更新：{formatDate(v.update_date)}
                    </p>
                    <p className="size-7 header-font mt-2 mt-sm-0">
                      已有 {recordCount.user_count} 人應徵
                    </p>
                  </div>
                </header>
                <section className="description my-4 py-1 ">
                  <div className="item d-flex flex-column ">
                    ...
                    <hr class="item-divider" />
                    <p className="size-7 d-flex align-items-center salary">
                      NT$ {v.price} / 次
                    </p>
                  </div>
                  <div className="item d-flex flex-column">
                    <div className="item-title size-6">
                      <CiCalendarDate className="me-1" />
                      任務日期
                    </div>
                    <hr class="item-divider" />
                    <p className="size-7 d-flex align-items-center  item-content">
                      {v.start_date === v.end_date
                        ...
                        : `${formatDate(v.start_date)}～${formatDate(
                            v.end_date
                          )}`}
                    </p>
                  </div>
                  <div className="item d-flex flex-column mission-place">
                    <div className="item-title size-6 position-relative">
                      ...
                      任務地點
                      <img
                        src="/job-icon/animation2.gif"
                        className="position-absolute running-cat"
                      />
                    </div>
                    <hr class="item-divider" />
                    <p className="size-7 d-flex align-items-center  item-content">
                  ...
                  <div className="item d-flex flex-column ">
                    <div className="item-title size-6">
                      <PiContactlessPaymentThin className="me-1" />
                      支付方式
                    </div>
                    <hr class="item-divider" />
                    <p className="size-7 d-flex align-items-center item-content">
