        ...
        <div className="cart my-3">
          <div className="container">
            ...
            <div className=" text-center zero d-flex flex-column justify-content-center align-items-center">
              ...
              <Link
                href="/product"
                className="size-2  mt-4 btn btn-outline-brown col-lg-6 col-9"
              >
                快去小貓商城逛逛吧
              </Link>
            </div>
                ...
                <thead>
                  <tr className="size-6">
                    <th className="text-center">
                      <input
                        type="checkbox"
                        className="form-check-input m-0 size-7"
                        checked={isChecked}
                        onChange={(e) => {
                      ...
                      <tr className="size-6" key={i}>
                        <td className="text-center ">
                          <input
                            type="checkbox"
                            checked={v.buy}
                            className="form-check-input size-7"
                            onChange={(e) => {
                ...
                <thead>
                  <tr className="m-size-5">
                    <th className="text-center">
                      <input
                        type="checkbox"
                        className="form-check-input m-0 m-size-7"
                        checked={isChecked}
                        onChange={(e) => {
                          handleToggleSelectedAll(e.target.checked);
                        }}
                ...
                >
                  ...
                  {coupon.map((v, i) => {
                    return (
                      <option
                        key={`coupon${i}`}
                        value={`${v.type},${v.amount},${v.coupon_id}`}
                      >
                        {v.title}
                      </option>
                    );
