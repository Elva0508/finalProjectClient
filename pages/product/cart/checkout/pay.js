    ...
    <>
      <div className="container my-5 pay">
        ...
        <div className="d-flex justify-content-center mb-4">
          <div className=" title">
            <p className="size-5  fw-bold">
              訂單編號：<span>{orderNumber}</span>
            </p>
            <p className="size-5  fw-bold">
              訂單金額：<span>{orderPrice}元</span>
            </p>
          </div>
        </div>
          ...
          >
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">確認要導向至LINE Pay進行付款？</div>
        ...
        <div className="pay">
          ...
          <div className="d-flex justify-content-center mb-4 ">
            ...
            <table className="col-12  d-none d-sm-block cart-d-content ">
              <thead>
                <tr>
                  <th colSpan="4" className="size-6">
                    訂單明細(
                    {finalCart[finalCart.length - 1].product_id == 0
                      ? finalCart.length - 1
                      : finalCart.length}
                    )
                  </th>
