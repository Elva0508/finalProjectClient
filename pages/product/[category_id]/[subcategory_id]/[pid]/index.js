...
export default function ProductDetail() {
  ...
  const calculatePercentageLengths = (starRatingLengths, starRatings) => {
    const percentageLengths = starRatingLengths.map((rating) => {
      // 計算每個星級評分的數量
      const ratingCount = starRatings.filter(
  ...
  // 獲取星星評分的百分比長度數組
  const percentageLengths = calculatePercentageLengths(
    starRatingLengths,
    starRatings
  );
  ...
  const addCart = async (product_id, product_type_id, quantity) => {
    ...
    const have = cart.find(
      (v) =>
        ...
        v.product_type_id == parseInt(product_type_id)
    );
    console.log(have);
          ...
          {productData.map((v, i) => {
            return (
              <>
                ...
                <section
                  className="product-itembox row justify-content-center"
                  key={v.product_id}
                >
                  <div className="product-pic d-flex col-lg-6">
                    <div className="d-flex flex-column other-pic">
                      <img
                        ...
                        className={
                          v.images_one === mainPic ? "selected-image" : ""
                        }
                      ></img>
                      <img
                        src={v.images_two}
                        ...
                        className={
                          v.images_two === mainPic ? "selected-image" : ""
                        }
                      ></img>
                    </div>
                  ...
                  <div className="product-detail col-lg-6">
                    ...
                    <div className="price-wrapper mt-2">
                      <div className="pricebox_detail  d-flex">
                        <div className="priceBlock me-4">
                          ...
                          <span className="font-big size-5">
                            {v.specialoffer}
                          </span>
                        </div>
                        <div className="font-delete size-7">
                          原價NT${v.price}
                        </div>
                      </div>
                    </div>
                    <div className="delivery-coupon size-7 d-flex flex-row mt-2">
                      <div className="free-delivery size-7 d-flex pe-2 ">
                        <div className="free-delivery-1 size-7 d-flex ">
                          免運
                        </div>
                        <div className="free-delivery-2 size-7 d-flex ">
                          滿千限時送
                        </div>
                      </div>
                      <div className="coupon size-7 d-flex  ">
                        <div className="coupon-1 size-7 d-flex ">會員</div>
                        <div className="coupon-2 size-7 d-flex ">
                          即領折扣券
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="additional-information mt-3">
                      ...
                      <li>
                        <FaPaw /> 付款後，3日內配送，台灣本島最快隔天送達
                      </li>
                      <li>
                        <FaPaw /> 商品提供宅配到府和超商取貨付款服務
                      </li>
                      <li>
                        <FaPaw /> 小貓上工服務上線!{" "}
                      </li>
                    ...
                    <div className="add-to-cart-fav mt-3 d-flex flex-row">
                      ...
                      >
                        {collection.some(
                          ...
                          <FaHeart color="#ca526f" size={29} />
                        ) : (
                          <FaRegHeart color="#d7965b" size={29} />
                        )}
                      </button>
                    </div>
                      ...
                      {cart.map((v, i) => {
                        return (
                          <>
                            <div
                              key={i}
                              className="d-flex mb-3 border-bottom mx-2"
                            >
                              <div className="">
                      ...
                      {starRatingLengths.map((rating, index) => (
                        <div className="bar-group" key={index}>
                          ...
                          <div className="percentage">
                            <div
                              className="have"
                              style={{ width: `${percentageLengths[index]}%` }}
                            ></div>
                            <div
                              className="no-have"
                              style={{
                                width: `${100 - percentageLengths[index]}%`,
                              }}
                            ></div>
                          </div>
                        </div>
              ...
              {reviewData.map((v, i) => {
                return (
                  <div className="customer" key={i}>
                    ...
                    <div className="customer-content">{v.review_content}</div>
                  </div>
                );
              })}
            </section>
